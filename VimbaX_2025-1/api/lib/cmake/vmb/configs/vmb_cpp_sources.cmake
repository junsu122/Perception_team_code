...
" PARENT_SCOPE)
    ...
    if(APPLE)
        file(MAKE_DIRECTORY "${PARAMS_GENERATED_INCLUDES_DIR}/VmbCPP")
        set(_CONFIG_FILE "${PARAMS_GENERATED_INCLUDES_DIR}/VmbCPP/config.h")
    else()
    ...
    if(APPLE) 
        set_target_properties(${PARAMS_TARGET_NAME} PROPERTIES
            PUBLIC_HEADER "${PUBLIC_HEADERS};${_CONFIG_FILE_ABSOLUTE}"
        )
    else()
        set_target_properties(${PARAMS_TARGET_NAME} PROPERTIES
