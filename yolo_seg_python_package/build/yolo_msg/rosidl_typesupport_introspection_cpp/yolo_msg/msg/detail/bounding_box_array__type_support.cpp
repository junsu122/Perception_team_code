...
{
  new (message_memory) yolo_msg::msg::BoundingBoxArray(_init);
}

void BoundingBoxArray_fini_function(void * message_memory)
{
  auto typed_message = static_cast<yolo_msg::msg::BoundingBoxArray *>(message_memory);
...
void fetch_function__BoundingBoxArray__boxes(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const auto & item = *reinterpret_cast<const yolo_msg::msg::BoundingBox *>(
    get_const_function__BoundingBoxArray__boxes(untyped_member, index));
  auto & value = *reinterpret_cast<yolo_msg::msg::BoundingBox *>(untyped_value);
  value = item;
}

void assign_function__BoundingBoxArray__boxes(
  void * untyped_member, size_t index, const void * untyped_value)
{
  auto & item = *reinterpret_cast<yolo_msg::msg::BoundingBox *>(
    get_function__BoundingBoxArray__boxes(untyped_member, index));
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember BoundingBoxArray_message_member_array[2] = {
  {
    ...
    offsetof(yolo_msg::msg::BoundingBoxArray, header),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(yolo_msg::msg::BoundingBoxArray, boxes),  // bytes offset in struct
    nullptr,  // default value
    ...
    fetch_function__BoundingBoxArray__boxes,  // fetch(index, &value) function pointer
    assign_function__BoundingBoxArray__boxes,  // assign(index, value) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers BoundingBoxArray_message_members = {
  ...
  2,  // number of fields
  sizeof(yolo_msg::msg::BoundingBoxArray),
...
{
  return &::yolo_msg::msg::rosidl_typesupport_introspection_cpp::BoundingBoxArray_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, yolo_msg, msg, BoundingBoxArray)() {
  return &::yolo_msg::msg::rosidl_typesupport_introspection_cpp::BoundingBoxArray_message_type_support_handle;
}
