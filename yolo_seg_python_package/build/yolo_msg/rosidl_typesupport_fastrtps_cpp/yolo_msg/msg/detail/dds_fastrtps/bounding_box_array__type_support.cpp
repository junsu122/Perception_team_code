...
#include "yolo_msg/msg/detail/bounding_box_array__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const yolo_msg::msg::BoundingBoxArray & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  yolo_msg::msg::BoundingBoxArray & ros_message)
{
  // Member: header
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = yolo_msg::msg::BoundingBoxArray;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const yolo_msg::msg::BoundingBoxArray *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<yolo_msg::msg::BoundingBoxArray *>(
    untyped_ros_message);
...
static size_t _BoundingBoxArray__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_BoundingBoxArray(full_bounded, is_plain, 0);
...
{
  return &yolo_msg::msg::typesupport_fastrtps_cpp::_BoundingBoxArray__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, yolo_msg, msg, BoundingBoxArray)() {
  return &yolo_msg::msg::typesupport_fastrtps_cpp::_BoundingBoxArray__handle;
}
