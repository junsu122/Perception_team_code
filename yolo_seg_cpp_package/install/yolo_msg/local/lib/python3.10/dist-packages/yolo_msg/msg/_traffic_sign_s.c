...
bool yolo_msg__msg__traffic_sign__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("yolo_msg.msg._traffic_sign.TrafficSign", full_classname_dest, 38) == 0);
  }
  yolo_msg__msg__TrafficSign * ros_message = _ros_message;
  {  // pose
...
PyObject * yolo_msg__msg__traffic_sign__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("yolo_msg.msg._traffic_sign");
