...
bool yolo_msg__msg__bounding_box__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("yolo_msg.msg._bounding_box.BoundingBox", full_classname_dest, 38) == 0);
  }
  yolo_msg__msg__BoundingBox * ros_message = _ros_message;
  {  // x
  ...
  {  // pixel_center_x
    PyObject * field = PyObject_GetAttrString(_pymsg, "pixel_center_x");
    if (!field) {
      return false;
    }
    assert(PyFloat_Check(field));
    ros_message->pixel_center_x = PyFloat_AS_DOUBLE(field);
    Py_DECREF(field);
  }
  {  // pixel_center_y
    PyObject * field = PyObject_GetAttrString(_pymsg, "pixel_center_y");
    if (!field) {
      return false;
    }
    assert(PyFloat_Check(field));
    ros_message->pixel_center_y = PyFloat_AS_DOUBLE(field);
    Py_DECREF(field);
  }
...
PyObject * yolo_msg__msg__bounding_box__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("yolo_msg.msg._bounding_box");
  ...
  {  // pixel_center_x
    PyObject * field = NULL;
    field = PyFloat_FromDouble(ros_message->pixel_center_x);
    {
      int rc = PyObject_SetAttrString(_pymessage, "pixel_center_x", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
  ...
  {  // pixel_center_y
    PyObject * field = NULL;
    field = PyFloat_FromDouble(ros_message->pixel_center_y);
    {
      int rc = PyObject_SetAttrString(_pymessage, "pixel_center_y", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
