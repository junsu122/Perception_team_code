...
{
  new (message_memory) yolo_msg::msg::TrafficSign(_init);
}

void TrafficSign_fini_function(void * message_memory)
{
  auto typed_message = static_cast<yolo_msg::msg::TrafficSign *>(message_memory);
  typed_message->~TrafficSign();
}

static const ::rosidl_typesupport_introspection_cpp::MessageMember TrafficSign_message_member_array[2] = {
  {
    "pose",  // name
    ...
    offsetof(yolo_msg::msg::TrafficSign, pose),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(yolo_msg::msg::TrafficSign, class_id),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers TrafficSign_message_members = {
  ...
  2,  // number of fields
  sizeof(yolo_msg::msg::TrafficSign),
...
get_message_type_support_handle<yolo_msg::msg::TrafficSign>()
{
  return &::yolo_msg::msg::rosidl_typesupport_introspection_cpp::TrafficSign_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, yolo_msg, msg, TrafficSign)() {
  return &::yolo_msg::msg::rosidl_typesupport_introspection_cpp::TrafficSign_message_type_support_handle;
}
