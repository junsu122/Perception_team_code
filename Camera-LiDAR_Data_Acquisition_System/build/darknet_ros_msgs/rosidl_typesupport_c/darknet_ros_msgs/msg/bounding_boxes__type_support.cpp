...
static const _BoundingBoxes_type_support_symbol_names_t _BoundingBoxes_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, darknet_ros_msgs, msg, BoundingBoxes)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, darknet_ros_msgs, msg, BoundingBoxes)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, darknet_ros_msgs, msg, BoundingBoxes)() {
  return &::darknet_ros_msgs::msg::rosidl_typesupport_c::BoundingBoxes_message_type_support_handle;
}
