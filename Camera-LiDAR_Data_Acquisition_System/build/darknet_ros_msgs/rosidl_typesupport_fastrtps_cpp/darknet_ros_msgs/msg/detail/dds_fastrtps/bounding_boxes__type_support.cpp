...
#include "darknet_ros_msgs/msg/detail/bounding_boxes__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
bool cdr_serialize(
  const darknet_ros_msgs::msg::BoundingBox &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
  ...
  size_t current_alignment)
{
  ...
  // Member: bounding_boxes
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        darknet_ros_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_BoundingBox(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    using DataType = darknet_ros_msgs::msg::BoundingBoxes;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const darknet_ros_msgs::msg::BoundingBoxes *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<darknet_ros_msgs::msg::BoundingBoxes *>(
    untyped_ros_message);
...
{
  return &darknet_ros_msgs::msg::typesupport_fastrtps_cpp::_BoundingBoxes__handle;
}
